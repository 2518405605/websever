...
import time
from rag_config import MILVUS_COLLECTION_NAME, MILVUS_DATABASE_NAME, MILVUS_URI, EMBEDDING_DIM
...
class MilvusCollectionManager:
    ...
    def __init__(self, uri: str = MILVUS_URI, db_name: str = MILVUS_DATABASE_NAME):
        """
        初始化Milvus集合管理器
...
if __name__ == "__main__":
    manager = MilvusCollectionManager(uri=MILVUS_URI, db_name=MILVUS_DATABASE_NAME)
    if manager.connect():
